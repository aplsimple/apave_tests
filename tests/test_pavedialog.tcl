...
- text\n- memo\n- note}
    ...
    ] -buttons {butChange {Edit it} 3 butUndo {Undo it} 4 butRedo {Redo it} 5} -head "Entries, choosers, switchers, boxes..." {*}$args]
    if {[lindex $res 0]} {
...
while 1 {
  ...
  puts --------------------------------
  set curr [set totr 0]
  foreach {n type} {8 INP 1 OK 2 YN 3 OC 4 YNC 5 RC 6 ARC 7 MSC 9 PAVEDOC} {
    if {[set r$n]<10} {
